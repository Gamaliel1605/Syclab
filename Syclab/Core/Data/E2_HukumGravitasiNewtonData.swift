...
struct E2_HukumGravitasiNewtonData {
    ...
    static let eksplorasiDetail = ExperimentDetails(expDesc: """
                                            ...
                                            """.withBoldText(text: "Tahukah kamu, bahwa gaya gravitasi dipengaruhi oleh massa benda dan jarak antar benda?").string,
    ...
    static let misiDetail = ExperimentDetails(expDesc: """
                                        ...
                                        """.withBoldText(text: "Oleh karena itu, sudah paham bukan bahwa gaya gravitasi berkaitan dengan massa antar benda dan juga jarak?").string,
                                                    expImage_1: "DetailHukumNewton1",
                                                    expImage_2: "DetailHukumNewton2")
