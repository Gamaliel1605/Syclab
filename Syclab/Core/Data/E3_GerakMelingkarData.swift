...
struct E3_GerakMelingkarData {
    
    static let experiment = Experiment(expTitle: "Gerak Melingkar",
                                       expImage: "GerakMelingkar",
                                       id: .E3_GerakMelingkar
    )
